<div class="flex bg-gray-200 overflow-x-hidden overflow-y-auto ease-in-out z-10 absolute top-0 right-0 bottom-0 left-0 items-center hidden"
    ...
    <div role="alert" class="container mx-auto w-11/12 md:w-2/3 max-w-lg">
        <div class="relative py-8 px-5 md:px-10 bg-white shadow-md rounded border border-gray-400">
            ...
            <form data-action="{{ route('import') }}" method="POST" enctype="multipart/form-data" id="import-csv">
                @csrf

                <div class="flex items-center justify-center w-full mb-2 mt-4" id="browse-file">
                    <label for="file-input"
                        ...
                        <div class="flex flex-col items-center justify-center pt-5 pb-6">
                            <svg aria-hidden="true" class="w-12 h-12 text-gray-400" fill="none" stroke="currentColor"
                            ...
                            <p class="font-medium truncate max-w-xs" id="show-file-name"></p>
                        </div>

                        <div style="display: none" class="flex progress items-center mb-3">
                        ...
                        <input accept=".csv" type="file" class="hidden" />
                    </label>
                </div>
            </form>
